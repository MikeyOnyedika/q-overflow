...
export const Searchbar = ({ handleBtnAction, actionBtnText, value, handleSetValue }) => {
    return (
        <div className="sticky top-2 w-full flex items-center gap-3 px-4 py-2 border-2 border-fuchsia-200 bg-fuchsia-100 rounded-2xl ">
            ...
            <input value={value} onChange={handleSetValue} placeholder="Search or Create post" className="text-lg text-gray-800 outline-none w-full bg-transparent " />
